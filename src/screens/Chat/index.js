    ...
    <View style={bawah.container}>
      ...
      <View style={bawah.chatContainer}>
        ...
        <View style={[bawah.chatInfo]}>
          <Text style={bawah.chatTitle}>Gojek A</Text>
          <Text style={bawah.chatSubtitle}>Pesanan anda akan diantar segera ...</Text>
        </View>
        <Text style={bawah.tanggalText}>12/11/23</Text>
      </View>
      <View style={bawah.borderBottom}></View>
      <View style={bawah.chatContainer}>
        <User size={30} color="black" />
        <View style={[bawah.chatInfo]}>
          <Text style={bawah.chatTitle}>Gojek B</Text>
          <Text style={bawah.chatSubtitle}>Mohon ditunggu pesanan anda.</Text>
        </View>
        <Text style={bawah.tanggalText}>12/11/23</Text>
      </View>
      <View style={bawah.borderBottom}></View>
      <View style={bawah.chatContainer}>
        <User size={30} color="black" />
        <View style={[bawah.chatInfo]}>
          <Text style={bawah.chatTitle}>Gojek C</Text>
          <Text style={bawah.chatSubtitle}>Pesanan anda telah selesai, beri ra...</Text>
        </View>
        <Text style={bawah.tanggalText}>10/10/23</Text>
      </View>
      <View style={bawah.borderBottom}></View>
    </View>
  );
