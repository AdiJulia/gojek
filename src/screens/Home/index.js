    ...
    <LinearGradient colors={['#F0F0F0', '#FFFFFF']} style={styles.gradientBackground}>
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <Image
            source={require('./src/c.jpg')} // Tentukan lokasi gambar di sini
        ...
        <Text style={{ marginHorizontal: '-35%', paddingVertical: 100, fontWeight: 'bold', fontSize: 19, left: '-21%', color: 'black' }}>Kasih rating dulu, yuk!</Text>
          ...
          <Car color={'green'} variant="Bold" size={22}  />
            ...
            <Image
            source={{uri: 'https://static.promediateknologi.id/crop/0x163:663x616/750x500/webp/photo/2023/06/02/driver-gojek-pertama-mulyono2-2959823713.jpg'}} // Tentukan lokasi gambar di sini
...
const styles = StyleSheet.create({
  ...
  imageStyle1: {
    top: '-19%',
    width:75, // Tentukan lebar gambar
    height:75, // Tentukan tinggi gambar
    resizeMode: 'cover',
    borderRadius: 20,
  },
  contentBox: {
