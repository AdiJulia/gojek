    ...
    <View style={bawah.container}>
      <View style={bawah.box1}>
        <Image
          style={bawah.image}
          source={{
            uri: 'https://gallery.poskota.co.id/storage/Foto/Foto_20230927_090504_zyr.jpeg',
          }}
        />
        <Text style={bawah.textAtas}>Diskon 90%</Text>
        <Text style={bawah.textBawah}>
          Untuk pemesanan gocar atau goride!
        </Text>
        <Image
          style={bawah.image}
          source={{
            uri: 'https://lelogama.go-jek.com/post_featured_image/promo-ramadhan-go-food-extension.jpg',
          }}
        />
        <Text style={bawah.textAtas}>Diskon s.d Rp.110.000</Text>
        <Text style={bawah.textBawah}>
         Diskon Ongkir
        </Text>
      </View>
